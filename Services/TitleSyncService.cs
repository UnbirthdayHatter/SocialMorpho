...
public sealed class TitleSyncService : IDisposable
{
    ...
    private static string GetStyleCode(string? preset)
    {
        return (preset ?? "Gold").Trim() switch
        {
            ...
            "Sunset Gradient" => "SD",
            "Seafoam Gradient" => "SF",
            "Valentione Gradient" => "VA",
            "Companion Gradient" => "CP",
            "Confidant Gradient" => "CF",
            "Muse Gradient" => "MU",
            "Heartbound Gradient" => "HB",
            "Lily Gradient" => "LY",
            "Royal Gradient" => "RY",
            "Aurora Gradient" => "AU",
            "Peach Fizz Gradient" => "PF",
            "Moonlit Gradient" => "ML",
            "Ember Gradient" => "EM",
            "Ocean Dusk Gradient" => "OD",
            "Spring Bloom Gradient" => "SB",
            "Crystal Sky Gradient" => "CS",
            "Stardust Gradient" => "ST",
            "Festival Gradient" => "FV",
            "Scholar Gradient" => "SC",
            "Rainbow Gradient" => "RB",
            _ => "G",
        };
    ...
    private static string GetStyleFromCode(string? code)
    {
        return (code ?? "G").Trim().ToUpperInvariant() switch
        {
            ...
            "SD" => "Sunset Gradient",
            "SF" => "Seafoam Gradient",
            "VA" => "Valentione Gradient",
            "CP" => "Companion Gradient",
            "CF" => "Confidant Gradient",
            "MU" => "Muse Gradient",
            "HB" => "Heartbound Gradient",
            "LY" => "Lily Gradient",
            "RY" => "Royal Gradient",
            "AU" => "Aurora Gradient",
            "PF" => "Peach Fizz Gradient",
            "ML" => "Moonlit Gradient",
            "EM" => "Ember Gradient",
            "OD" => "Ocean Dusk Gradient",
            "SB" => "Spring Bloom Gradient",
            "CS" => "Crystal Sky Gradient",
            "ST" => "Stardust Gradient",
            "FV" => "Festival Gradient",
            "SC" => "Scholar Gradient",
            "RB" => "Rainbow Gradient",
            _ => "Gold",
        };
